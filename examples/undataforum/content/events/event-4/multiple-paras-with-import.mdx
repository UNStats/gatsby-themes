---
title: This is a webinar with moderators and speakers
date: 2019-08-29T09:00
endDate: 2019-08-29T10:30
...
case **multiple paragraphs with import statement before the first paragraph**.
This is a filler sentence to make the first paragraph longer. If you see this
...
<Box mb={3}>
  <Video
    id="Vb0c_sIzoUw"
    title="Webinar: Quis laborum ipsum non mollit ex magna consectetur id amet voluptate"
    ratio={16 / 9}
  />
</Box>
...
- [Nance McFadin](./nance-mcfadin.pdf)
- [Suzy Cahan](./suzy-cahan.pdf)
